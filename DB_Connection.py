...
class DB_Access:
    ...
    def __init__(self):
        ...
        self.db = mysql.connector.connect(host='127.0.0.1', user="root", password="User@123", database="emp_info1")
    ...
    def register_user(self):
        ...
        if username_info == "":
            ...
            sql = "insert into info12 values(%s,%s,%s,%s)"
    ...
    def login_varify(self):
            ...
            sql = "select * from info12 where username = %s and passwd = %s"
